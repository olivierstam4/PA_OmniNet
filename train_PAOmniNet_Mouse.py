...
class CustomH5Dataset(Dataset):
    def __init__(self, data_in, data_out, context_size=4):
...
class LightningModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # ssim_val = self.ssim(y_pred, y.to(DEVICE))
        # loss = 1 - ssim_val
        # alpha = 0.84
        # mse_value =  F.mse_loss(y_pred, y)
        # ssim_value = self.ssim(y_pred, y.to(DEVICE))
        # loss = (1-alpha) * mse_value + alpha * (1- ssim_value)
...
if __name__ == "__main__":
    ...
    mice = ['../../Datasets/optoacousticsparse/mice_sparse16_recon_256.mat',
            ...
            '../../Datasets/optoacousticsparse/mice_full_recon_256.mat',
            '../../Datasets/optoacousticsparse/mice_sparse64_recon_256.mat',
    ...
    phantom = ['../../Datasets/optoacousticsparse/phantom_sparse16_recon_256.mat',
               '../../Datasets/optoacousticsparse/phantom_sparse32_recon_256.mat',
               '../../Datasets/optoacousticsparse/phantom_full_recon_256.mat']
    ...
    checkpoint_callback = ModelCheckpoint(
        monitor='val_loss',
        dirpath='checkpointsrevison/',
        filename='PAOmni_mse_mouse128',
        save_top_k=1,
        mode='min'
    )
