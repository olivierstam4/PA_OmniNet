...
BATCH_SIZE = 128
START_FILTERS = 32
MODEL_SAVE_PATH = "unet_model_multi_patient.pth"
...
if __name__ == '__main__':
    ...
    train_patient_ids = list(range(1, 11))
    val_patient_ids = [11, 12]
    test_patient_ids = [13, 14]
    ...
    for epoch in range(EPOCHS):
        ...
        if val_loss < best_val_loss:
            ...
            logger.info(f"Validation loss improved. Model saved as best_model_Multi.pth.")
        else:
