...
BATCH_SIZE = 128
START_FILTERS = 32
MODEL_SAVE_PATH = "unet_model_SCD_early.pth"
DEVICE = "cuda" if torch.cuda.is_available() else "cpu"
...
if __name__ == '__main__':
    ...
    for epoch in range(EPOCHS):
        ...
        if val_loss < best_val_loss:
            ...
            early_stop_counter = 0
            torch.save(model.state_dict(), "Unet_SCD_ssim.pth")
        ...
        if (epoch + 1) % 50 == 0:
            checkpoint_path = os.path.join("checkpoints", f"Unet_SWFDMulti_patient_{epoch + 1}.ckpt")
